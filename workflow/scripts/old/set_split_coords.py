...
adj_top = int(samples_df.loc[SAMPLE, "adj_top"][0])
adj_bottom = int(samples_df.loc[SAMPLE, "adj_bottom"][0])
adj_left = int(samples_df.loc[SAMPLE, "adj_left"][0])
adj_right = int(samples_df.loc[SAMPLE, "adj_right"][0])
