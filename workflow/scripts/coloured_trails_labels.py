...
## Debug
video_object_path = "/hps/nobackup/birney/users/ian/MIKK_F0_tracking/split/novel_object/20191115_1251_104-1_L_A/session_20191115_1251_104-1_L_A_q1/video_object.npy"
trajectories_path = "/hps/nobackup/birney/users/ian/MIKK_F0_tracking/split/novel_object/20191115_1251_104-1_L_A/session_20191115_1251_104-1_L_A_q1/trajectories_wo_gaps/trajectories_wo_gaps.npy"
...
SAMPLE = "20191115_1251_104-1_L_A"
REF_LOC = "Left"
...
# Read in colours csv and create dictionary
col_df = pd.read_csv(COLOURS_CSV)
col_dict = dict(zip(list(col_df.line), list(col_df.colour)))

# Add iCab ref/test to dictionary
col_dict['iCab_ref'] = '#F1BB7B'
col_dict['iCab_test'] = '#AB7535'
...
bgr_values = [hex2bgr(i) for i in col_dict.values()]
pal_dict_bgr = {list(col_dict.keys())[i] : bgr_values[i] for i in range(len(col_dict))}
